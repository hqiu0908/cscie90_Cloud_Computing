...
public class CustomerResourceClient_P4 {
	public static void main(String[] args) {
		try {
			System.out.println("\n*** Create a new Customer ***");
			// Create a new customer5
			...
			URL postUrl = new URL("http://172.31.60.219:8080/rest/customers");
			...
			URL getUrl = new URL("http://172.31.60.219:8080/rest/customers/1");
			...
			getUrl = new URL("http://172.31.60.219:8080/rest/customers/1");
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
			...
			for (String customer : newCustomers) {
				postUrl = new URL("http://172.31.60.219:8080/rest/customers");
			...
			System.out.println("\n*** GET All the Customers ***");
			getUrl = new URL("http://172.31.60.219:8080/rest/customers");
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
			...
			getUrl = new URL("http://172.31.60.219:8080/rest/customers/" + startingId + "/" + numOfCustomersToReturn);
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
			...
			System.out.println("\n*** Delete One Particular Customer ***");
			getUrl = new URL("http://172.31.60.219:8080/rest/customers/3");
			connection = (HttpURLConnection) getUrl.openConnection();
